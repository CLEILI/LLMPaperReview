...
def writeinfo(papername:str,score:str,comment:str,fname:str)->str:
    with open(chatout_dir+f"/{fname}.txt", mode='a+') as filename:#a+(append) w+(from top)
...
def review(pdf:list,retrieval_functions:dict,round:int):
    '''
