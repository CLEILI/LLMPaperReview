...
After evaluating all the standards and asking the sufficient questions at the end of the groupchat, they must think step by step, chiefeditor gives a final score of all papers based on the review comments and discuss process. (The maximum score is 100, which should be accurate to two decimal places.) 
...
At last, chiefeditor just need to reply every paper's information in the follwing examples' format:
