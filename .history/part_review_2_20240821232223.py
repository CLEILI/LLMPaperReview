...
def review(pdf:list,retrieval_function):
    ...
    To find the paper related content, you are supposed to call answer functions.
    ...
    Here are the examples of your questions:
    ...
    After evaluating all the eight standards, you must think step by step, compare all papers and decide a final score of every paper based on the responses of all tool calls. (The maximum score is 100, which should be accurate to two decimal places.) 
