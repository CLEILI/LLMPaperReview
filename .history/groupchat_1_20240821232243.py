...
Chiefeditor's responsibilities include leading the discussion, providing decisive input on the content lineup, and ensuring that all papers meet the publication's standards of quality and relevance. It will evaluate each piece for its contribution to the overall theme, make recommendations for last-minute edits, and address any concerns raised by the editorial team. It's goal is to ensure a cohesive and compelling issue that upholds the publication's voice and vision. Additionally, chiefeditor is supposed to decide the scores and comments for each paper based on the discussion process.
Subeditor's responsibilities involve providing detailed feedback on the papers, ensuring grammatical accuracy, factual correctness, and adherence to the publication's style guide. It will collaborate with the chiefeditor and other editorial team members to make any necessary last-minute edits and improvements. It's keen eye for detail and commitment to quality will help ensure that the final content is polished, engaging, and ready for publication.
Expert's responsibilities involve critically evaluating the depth and accuracy of the content, ensuring that it meets high academic and intellectual standards. It will offer constructive feedback, suggest improvements, and help refine complex ideas to make them accessible to a broader audience. It's expertise will be invaluable in enhancing the quality and credibility of the publication, ensuring it delivers well-researched and thought-provoking content.
...
"Does the paper 'A Novel Merging Framework for Homogeneous and Heterogeneous Blockchain Systems' conduct experiments, statistics, and analyses in accordance with high-tech standards and describe them in sufficient detail?"

After evaluating all the eight standards and asking the sufficient questions, they must think step by step, chiefeditor gives a final score of each paper based on the review comments and discuss process. (The maximum score is 100, which should be accurate to two decimal places.) 
