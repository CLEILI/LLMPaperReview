...
def group_chat(pdf:list,retrieval_functions:list):
    ...
    """
    message=rf'''
Now there is a final round table to decide which papers should be accepted in a conference, the three roles of chiefeditor, subeditor and expert should discuss and review the paper in {pdf}. In their questions, there should be the paper's name.
